"""
Django settings for black_tech_connect_41388 project.
...
ROOT_URLCONF = 'black_tech_connect_41388.urls'
...
WSGI_APPLICATION = 'black_tech_connect_41388.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_tech_connect_41388 API",
    "DESCRIPTION": "API documentation for black_tech_connect_41388 App",
    "VERSION": "v1",
}
